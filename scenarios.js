const SCENARIOS = [
    ...
    },
    {
        ...
        isAntipattern: false,
        explanation: "スプリントレトロスペクティブで決めた改善アクションを実際に実行するのは素晴らしいプラクティスです。",
        practice: "スプリントレトロスペクティブの改善アクションを必ず実行する",
        antipattern: "スプリントレトロスペクティブが反省会だけで終わる"
    },
    {
        id: 3, difficulty: 1,
        ...
        isAntipattern: true,
        explanation: "スプリント中にスプリントゴールの達成に影響があるスコープ変更をするのはアンチパターンです。",
        practice: "スプリントバックログの変更によってスプリントゴールの達成に悪影響を及ぼさない",
        antipattern: "スプリント中に開発者の同意なしに要件を追加する"
    },
    {
        id: 4, difficulty: 1,
    ...
    },
    {
        ...
        dialogue: "「プロダクトバックログは順番をつけて整理してます。ステークホルダーとも定期的に話してます。」",
        document: {
            teamName: "チームイータ",
            sprintLength: "2週間",
    ...
    },
    {
        ...
        dialogue: "「完成の定義？まあ動けば完成でしょ。テストはあとで誰かやるよ。」",
        document: {
            teamName: "チームイオタ",
            sprintLength: "2週間",
        ...
        isAntipattern: true,
        explanation: "完成の定義はチームで明確に定義し、全員が守るべきです。",
        practice: "完成の定義を明確にし、遵守する",
        antipattern: "完成の定義が曖昧なまま進める"
    },
    {
        id: 10, difficulty: 2,
        character: { avatar: "👩‍🔬", role: "スクラムマスター", name: "加藤" },
        dialogue: "「チームの障害を取り除くように働きかけるのが私の仕事の1つ。今日も他部署と調整してきました！」",
        document: {
            teamName: "チームカッパ",
            sprintLength: "2週間",
    ...
    // --- 追加シナリオ 11-15 + レジェンド ---
    {
        ...
        document: {
            ...
            credential: "スクラム共同作成者",
            notes: "フレームワークの本質を理解している"
        },
        isAntipattern: false,
        explanation: "ジェフ・サザーランド氏はスクラムの共同作成者。スクラムは方法論ではなくフレームワークであり、チームがやり方を決めます。",
        practice: "スクラムはフレームワーク、チームが自律的に動く",
        antipattern: "スクラムを厳密なルールとして強制する"
    },
    {
        id: 12, difficulty: 2,
        character: { avatar: "🧔", role: "スクラム共同作成者", name: "ケン・シュエイバー" },
        dialogue: "「Scrum exposes the truth. It doesn't solve your problems, it makes them visible.」",
        document: {
            teamName: "Scrum.org",
            sprintLength: "1-4週間",
            transparency: "透明性を重視",
            credential: "スクラムガイド共同作成者",
            notes: "スクラムの精神を体現している"
        },
        isAntipattern: false,
        explanation: "ケン・シュエイバー氏はスクラムの共同作成者。スクラムは問題を可視化するフレームワークです。",
    ...
    },
    {
        ...
        isAntipattern: true,
        explanation: "これは偶物です！デイリースクラムは15分以内です。本物のジェフはそんなこと言いません。",
    ...
    },
    {
        ...
        dialogue: "「このまま行くとスプリントゴールを達成できそうか、達成の可能性を上げるためにできることをシンプルに共有してます！」",
        document: {
            teamName: "チームラムダ",
            sprintLength: "2週間",
            dailyScrum: "毎日15分",
        ...
        isAntipattern: false,
        explanation: "デイリースクラムでスプリントゴール達成の可能性を検査するのは良いプラクティスです。",
        practice: "デイリースクラムはスプリントゴールを中心にして短く",
    ...
    // --- 追加シナリオ 16-20 ---
    {
        ...
        dialogue: "「プロダクトバックログアイテムの順番？まあ、都度変わるけどいいよね？」",
        document: {
            teamName: "チームミュー",
            sprintLength: "2週間",
